...
const Register = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void }) => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            console.log(erro)
            const errorMessage = erro.response?.data?.message || erro.message || "Registration failed. Please try again."
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 flex items-center justify-center p-4">
            ...
            <Modal show={success}>
                <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-br from-green-900 via-green-800 to-green-700 rounded-2xl shadow-2xl border border-green-400/20 backdrop-blur-xl">
                    ...
                    <span className="text-white font-semibold text-lg tracking-wide drop-shadow-[0_0_8px_#4ade80] text-center">
